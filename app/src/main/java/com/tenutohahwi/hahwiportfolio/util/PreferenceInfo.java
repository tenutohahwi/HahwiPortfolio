...
public class PreferenceInfo {
	...
	public static final String PREF_NAME = "com.tenutohahwi.hahwiportfolio.pref";
	...
	public static final String STUDY_MODE = "study_mode";  // yes, no 열공모드인지 아닌지
	public static final String STUDY_MODE_START = "study_mode_start"; //열공모드 시작 날짜 , 일주일마다 변경됨
	public static final String STUDY_MODE_ISALARM = "study_mode_isalarm"; //열공모드 알람 매니저 등록됬는지 확인
	public static final String STUDY_MODE_LEVEL = "study_mode_level"; //열공모드 레벨
	...
	public static final String PROFILE_IMAGE_UPLOAD = "profile_image_upload";  //프로필 이미지 서버에 전송여부
	public static final String PROFILE_IMAGE_UPLOAD_CROP = "profile_image_upload_crop";  //프로필 이미지 서버에 전송여부
	public static final String PROFILE_BG_IMAGE_UPLOAD = "profile_bg_image_upload"; //프로필 배경 이미지 서버에 전송여부
